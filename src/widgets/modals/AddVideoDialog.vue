...
import { useStreamers, useUserInfo } from '@/entities'
import type { IUploadVideo, IWallet } from '@/shared/config/types/slicer'
...
const VideoUploader = defineAsyncComponent(() => import('@/widgets/modals/VideoUploader.vue'))
