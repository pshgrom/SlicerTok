...
import { adminInfoHeaders } from '@/shared/config'
import type {
  ITableHeaders,
  ITableParamsAdmin,
  IUserInfoData
} from '@/shared/config/types/app-model'
import { DateFilter, SvgIcon, TablePagination, TabsSwitcher, VCusomButton } from '@/shared/ui'
import { SidePanel } from '@/widgets/side-panel'
import { TableAdminInfo } from '@/widgets/tables'
